...
export const GenericListItemSection = (): JSX.Element => {
  return (
    <div className="group relative flex flex-col items-center justify-center p-6 md:p-8 rounded-2xl bg-gradient-to-br from-[#f5a623] to-[#ff8f00] text-white min-h-[200px] overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl cursor-default">
