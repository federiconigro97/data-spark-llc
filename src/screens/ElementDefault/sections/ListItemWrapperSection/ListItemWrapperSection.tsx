...
export const ListItemWrapperSection = (): JSX.Element => {
  return (
    <div className="group relative flex flex-col items-center justify-center p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#2d5a4a] to-[#3d7a5a] text-white min-h-[160px] sm:min-h-[180px] md:min-h-[200px] overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl cursor-default">
